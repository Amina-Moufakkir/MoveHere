...
**Version 4.4 — Park-first, venue-aware, evidence-driven**
...
>
> **Supersedes v4.3**, which is retained unchanged as the historical product authority for that version. v4.4 changes no invariant, no gate and no exclusion. It brings implementation status factually current, records a sequencing decision, and separates MoveHere's target product experience from its currently authorized capability.
