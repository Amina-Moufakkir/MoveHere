...
| Muscles worked, agonists, activation percentages | `ACE-LIB` throughout including 49 glute bridge, `MCGILL-AC` |
...
`thoracic-rotation` — both still unverified — so this may be a family rather
than an instance.
